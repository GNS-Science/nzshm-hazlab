...
general_task_id = 'R2VuZXJhbFRhc2s6MTAyOTM0'
...
sites = ['Wellington','Auckland','Blenheim','Franz Josef','Queenstown','Greymouth','Gisborne','Taupo','Whakatane','Tauranga']
plot_dir = '/home/chrisdc/NSHM/oqresults/jump_distance_test'
